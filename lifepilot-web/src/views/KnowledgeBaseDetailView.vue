...
import type { KbDocument, KbStats, ProcessingLog, TestRetrievalResult } from '@/types'
import { 
  Search, Filter, Upload, FileText, RefreshCw, Trash2, Eye, 
  Download, AlertCircle, CheckCircle, Clock, XCircle, FileIcon,
...
async function handleFileChange(e: Event) {
  ...
  for (const file of Array.from(files)) {
    try {
      await store.uploadDocument(kbId.value, file)
    } catch (e: any) {
          ...
          <div class="space-y-3">
            ...
            <div v-if="testResult" class="space-y-3">
              ...
              <div v-if="testResult.chunks.length > 0">
                ...
                <div class="space-y-2">
                  <div
                    v-for="(chunk, idx) in testResult.chunks"
                    :key="chunk.chunkId"
