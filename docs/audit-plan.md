...
| 16 | 系统设置管理（Web UI 可视化配置，替代手动编辑 application.yml） | 新增 | 3-5 天 |

### 第三优先级（🟢 低 — 锦上添花）

| 序号 | 任务 | 来源 | 预估工作量 |
|------|------|------|-----------|
| 17 | DataStore 浏览页面 | P-03, F-04 | 2 天 |
| 18 | 沙箱管理入口 | P-04, F-05 | 1 天 |
| 19 | Eval 评估结果页面 | F-06 | 2 天 |
| 20 | 对话历史自动清理策略 | D-06 | 1 天 |
| 21 | Config 模块测试 | C-06 | 0.5 天 |
