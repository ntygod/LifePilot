...
graph LR
    ...
    subgraph "Flyway 迁移（V1~V18）"
        ...
        V15["V15: 记忆 lifecycle 闭环（status/completed_at/superseded_by/cancelled_reason 等字段）"]
        V16["V16: temporal_entities_view 扩展 lifecycle 字段"]
        V17["V17: proactive_task ↔ insight 关联表"]
        V18["V18: proactive_reminder ↔ insight 关联"]
    end
