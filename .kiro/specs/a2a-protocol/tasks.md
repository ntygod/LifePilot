...
- [x] 5. 实现 REST Controller 和 API Key 过滤器
...
- [x] 7. 实现 Client 层组件
  ...
  - [x] 7.5 实现 RemoteAgentToolFactory
...
- [x] 9. 实现配置和自动装配
  ...
  - [x] 9.4 注册 AutoConfiguration 到 spring.factories / imports
