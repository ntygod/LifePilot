...
/**
 * OpenAI 官方 (o-系列 / GPT-5) 适配器 — 复用 OpenAI SDK 路径，
 * thinking 字段走 reasoning_effort 原生参数。
 *
 * <p>Phase 3 阶段仅保留构造器，行为复用 {@link OpenAiBaseProviderAdapter}；
 * Phase 4 由基类按 {@link ThinkingProtocol} 注入 reasoning_effort 并发出 LlmStreamEvent。
 *
 * @author zsg
 * @since 2026-04-27
 */
public class OpenAiOfficialProviderAdapter extends OpenAiBaseProviderAdapter {

    public OpenAiOfficialProviderAdapter(ProviderConfig config,
                                         ChatModel chatModel,
