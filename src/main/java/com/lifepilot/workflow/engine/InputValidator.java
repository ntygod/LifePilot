...
public class InputValidator {
    ...
    public static InputValidationResult validate(
        ...
        if (paramDefs == null || paramDefs.isEmpty()) {
            return new InputValidationResult(true, List.of(), new HashMap<>(safeInputs));
        }
        ...
        return new InputValidationResult(missingParams.isEmpty(), List.copyOf(missingParams), mergedInputs);
    }
}
