...
class BenchmarkScenarioTest {
    ...
    void 必填字段id为null_抛出NullPointerException() {
        assertThrows(NullPointerException.class, () ->
                new BenchmarkScenario(null, "name", "input", List.of(), null, Map.of(), 60, null, null, List.of(), null, 1000, 3));
    }

    @Test
    void 必填字段name为null_抛出NullPointerException() {
        assertThrows(NullPointerException.class, () ->
                new BenchmarkScenario("id", null, "input", List.of(), null, Map.of(), 60, null, null, List.of(), null, 1000, 3));
    }

    @Test
    void 必填字段userInput为null_抛出NullPointerException() {
        assertThrows(NullPointerException.class, () ->
                new BenchmarkScenario("id", "name", null, List.of(), null, Map.of(), 60, null, null, List.of(), null, 1000, 3));
    }

    @Test
    void 可选字段为null_构造成功() {
        var scenario = new BenchmarkScenario("id", "name", "input", null, null, null, 60, null, null, null, null, 1000, 3);
    ...
    void 集合字段防御性拷贝_修改原集合不影响record() {
        ...
        var scenario = new BenchmarkScenario("id", "name", "input", tools, null, weights, 60, mocks, ctx, tags, null, 1000, 3);
    ...
    void 集合字段不可变_修改抛出异常() {
        var scenario = new BenchmarkScenario("id", "name", "input", List.of("tool1"), null,
                Map.of("dim1", 1.0), 60, Map.of("t", "r"), Map.of("k", "v"), List.of("tag"), null, 1000, 3);
