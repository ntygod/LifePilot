...
class ConsolidationPipeline触发模式测试 {
    ...
    void setUp() {
        ...
        pipeline = new ConsolidationPipeline(semanticConsolidator, proceduralConsolidator, properties);
    ...
    void IDLE模式_Cron触发被跳过() {
        ...
        var cp = new ConsolidationPipeline(semanticConsolidator, proceduralConsolidator, properties);
