...
/**
 * Phase D 完成验证 —— 确认 classpath 下全部 BUILTIN Skill 都符合 v3 规范、
 * 经 SkillInstaller 完整流水线校验成功，不再有 skipped。
 *
 * <p>这里只验证当前 classpath 中仍保留的 BUILTIN Skill 全部可安装。</p>
 *
 * @author zsg
 * @since 2026-04-24
 */
class SkillDiscoveryRegistrar_全量迁移测试 {
    ...
    void 启动后classpath下全部BUILTIN_Skill都应安装成功_无任一被跳过() {
        ...
        var validator = new SkillValidator(new SkillDescriptionValidator(), new SkillBodyValidator(),
