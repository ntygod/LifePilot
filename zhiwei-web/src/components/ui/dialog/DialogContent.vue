  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogClose
        ...
        class="ring-offset-background focus:ring-ring absolute top-4 right-4 rounded-[0.75rem] border border-transparent p-1.5 text-muted-foreground opacity-72 transition-[opacity,background-color,color,border-color] hover:border-border/50 hover:bg-accent/56 hover:text-foreground hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
      >
        <X />
